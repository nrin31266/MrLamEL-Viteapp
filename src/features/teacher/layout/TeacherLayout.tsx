  ...
  return (
     <div className="h-screen flex bg-gray-50">
      ...
      <div className={`transition-all duration-300 flex-shrink-0`}>
        <TeacherMenu collapsed={collapsed} onCollapse={onCollapse} isLarge={isLarge} />
      </div>
      
      {/* Main Content Area */}
      <div className="flex-1 w-full flex flex-col overflow-hidden">
        {/* Fixed Header */}
        <TeacherHeader collapsed={collapsed} onCollapse={onCollapse} />
        ...
        <main className="flex-1 overflow-auto">
          ...
          <footer className="bg-gray-100 border-t border-gray-200 py-4 text-center text-sm text-gray-600">
            Teacher Panel ©2024 Created by MrLamEL
          </footer>
        </main>
      </div>
    </div>
