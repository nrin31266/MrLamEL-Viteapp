...
//   }
// );
export const fetchTimeTableForWeek = createAsyncThunk<ITimeTableForTeacherByWeekDto, { teacherId: number, weekNumber: number }>(
  "teacher/timeTableForWeek",
  async (params, { rejectWithValue }) => {
    try {
      const data = await handleAPI<ITimeTableForTeacherByWeekDto>({
        endpoint: `/api/v1/teacher/classes/${params.teacherId}/time-table/week`,
        method: "GET",
